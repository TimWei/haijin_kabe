...
def new_sche
	...
	`schtasks /create /TN haijin_kabe_get /SC MINUTE /MO #{FREQ['kabe']} /TR "#{HIDE_WIN} ruby #{PATH}/lib/kabe.rb " `
	# change wallpaper 15 mins
	`schtasks /create /TN haijin_kabe_change /SC MINUTE /MO #{FREQ['chwall']} /TR "#{HIDE_WIN} ruby #{PATH}/lib/chwall_win.rb" `
end
