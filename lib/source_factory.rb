...
class SourceFactory
  def initialize opt={}
    ...
    when 'pixiv.moe'
      @product = ThirdPartyApi.new host_name: 'https://api.pixiv.moe/', path: 'v1/ranking', url_pattern: /large":"(https:.\/.\/api\.pixiv\.moe.\/v[0-9].\/image.\/i\.pximg\.net.\/img-original.\/img.\/([0-9a-z_]+|.\/)+\.(jpg|png))/
    # when 'imjad.cn'
